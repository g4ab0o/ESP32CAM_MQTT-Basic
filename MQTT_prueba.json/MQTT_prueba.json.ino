 ...
 * CONEXION A RED LOCAL, Modificacion del tema de suscripcion 
 * 
 */
...
//Datos de WiFi
const char* ssid = "TP-Link_A412";  // Aquí debes poner el nombre de tu red
const char* password = "_L4gun3z";  // Aquí debes poner la contraseña de tu red
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    client.publish("esp32/data/uli", dataString); // Esta es la función que envía los datos por MQTT, especifica el tema y el valor
